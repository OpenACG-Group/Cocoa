...
import { FFT } from './fft';
import { CloseRequestEvent, ToplevelWindow } from "../graphics/platform/ToplevelWindow";
import { Rect } from "../graphics/base/Rectangle";
import { PaintEvent } from '../graphics/platform/DrawContext';
...
class RenderContext {
    ...
    public renderCoverImage(image: gl.CkImage): void {
        this.fBGNode.setBoundsInParent(Rect.MakeWH(this.fWidth, this.fHeight));
        this.fBGNode.updateDrawCallback(C => {
        ...
        this.fCoverImageNode.setBoundsInParent(bounds);
        this.fCoverImageNode.updateDrawCallback(C => {
    ...
    public render(triples: FFTResultTriple[]): void {
        ...
        this.fPaintNode.setBoundsInParent(bounds);
        this.fPaintNode.updateDrawCallback(C => {
