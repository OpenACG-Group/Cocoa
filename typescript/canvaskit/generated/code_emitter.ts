...
export const kHeapCreateAlphaThresholdImageFilter = 0x32;
...
export const kHeapCreateDisplacementMapImageFilter = 0x38;
...
export const kHeapCreateDropShadowImageFilter = 0x39;
...
export const kHeapCreateDropShadowOnlyImageFilter = 0x3a;

// Description: HeapCreateMagnifierImageFilter any %key, rect %srcRect, f32 $inset, imagefilter? %input, rect? %crop
export const kHeapCreateMagnifierImageFilter = 0x3b;
...
export class ProtoCodeEmitter {
  ...
  public emitMarkBoundMemOpRequirement(op: MemOp): void {
  ...
  public emitDebugPrint(content: MemOp): void {
    this.writer.performPossibleBufferSwitching(6);
  ...
  public emitProfilingBreakpoint(bpid: number): void {
    this.writer.performPossibleBufferSwitching(6);
    this.writer.writeUint16Unsafe(Opcode.kProfilingBreakpoint | 0x100);
    this.writer.writeUint32Unsafe(bpid);
  }
  public emitMarkRelocationBreakpoint(bpid: number): void {
    this.writer.performPossibleBufferSwitching(6);
