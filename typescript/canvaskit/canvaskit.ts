...
export class Canvas extends IRAssemblerBase {
    ...
    public annotateDebugPrint(content: string): void {
    ...
    public insertProfilingBreakpoint(func: () => void): void {
        this.breakpointIdCounter++;
    ...
    public submit(): Glamor.MoeTranslationResult {
        ...
        let breakpointHandlers: Glamor.MoeExternalBreakpointHandlers = {
            debugCallback: (id) => {
                // TODO: implement this.
            },
