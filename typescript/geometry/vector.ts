...
import {GeoPrimitiveBase} from "./geometry_base";
 ...
 */
export interface IVector<T> extends GeoPrimitiveBase {
    /**
...
export class Vector2f implements IVector<Vector2f> {
    ...
    multiply(lambda: number): Vector2f {
...
export class Vector3f implements IVector<Vector3f> {
    ...
    multiply(lambda: number): Vector3f {
