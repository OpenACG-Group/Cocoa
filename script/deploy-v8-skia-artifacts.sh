...
so_library_files=(
    'v8/out/shared/libv8.so'
    'v8/out/shared/libv8_libbase.so'
    'v8/out/shared/libv8_libplatform.so'
    'v8/out/shared/libchrome_zlib.so'
    'v8/out/shared/libicuuc.so'
    'v8/out/shared/libicui18n.so'
...
v8_resource_files=(
    'v8/out/shared/snapshot_blob.bin'
)
