...
#ifndef COCOA_GALLIUM_BINDER_CONVERT_H
#define COCOA_GALLIUM_BINDER_CONVERT_H
...
struct convert<T*, typename std::enable_if<is_wrapped_class<T>::value>::type>
{
    ...
    static from_type from_v8(v8::Isolate *isolate, v8::Local<v8::Value> value)
    {
        ...
        return Class<class_type, raw_ptr_traits>::unwrap_object(isolate, value);
    }

    static to_type to_v8(v8::Isolate *isolate, T const *value)
    {
        return Class<class_type, raw_ptr_traits>::find_object(isolate, value);
    }
};
...
struct convert<T, typename std::enable_if<is_wrapped_class<T>::value>::type>
{
    ...
    static from_type from_v8(v8::Isolate *isolate, v8::Local<v8::Value> value)
    {
        ...
        T *object = Class<class_type, raw_ptr_traits>::unwrap_object(isolate, value);
        if (object)
        {
            return *object;
        }
    ...
    static to_type to_v8(v8::Isolate *isolate, T const& value)
    {
        v8::Local<v8::Object> result = Class<class_type, raw_ptr_traits>::find_object(isolate, value);
...
struct convert<std::shared_ptr<T>, typename std::enable_if<is_wrapped_class<T>::value>::type>
{
    ...
    static from_type from_v8(v8::Isolate *isolate, v8::Local<v8::Value> value)
    {
        ...
        return Class<class_type, shared_ptr_traits>::unwrap_object(isolate, value);
    }

    static to_type to_v8(v8::Isolate *isolate, std::shared_ptr<T> const& value)
    {
        return Class<class_type, shared_ptr_traits>::find_object(isolate, value);
    }
};
...
struct convert<T, ref_from_shared_ptr>
{
    ...
    static from_type from_v8(v8::Isolate *isolate, v8::Local<v8::Value> value)
    {
        ...
        std::shared_ptr<T> object = Class<class_type, shared_ptr_traits>::unwrap_object(isolate, value);
        if (object)
        {
    ...
    static to_type to_v8(v8::Isolate *isolate, T const& value)
    {
        v8::Local<v8::Object> result = Class<class_type, shared_ptr_traits>::find_object(isolate, value);
        if (!result.IsEmpty()) return result;
        throw std::runtime_error("failed to wrap C++ object");
    }
};
...
inline invalid_argument::invalid_argument(v8::Isolate *isolate, v8::Local<v8::Value> value, char const *expected_type)
        : std::invalid_argument(std::string("expected ")
            + expected_type
            + ", typeof="
            + (value.IsEmpty() ? std::string("<empty>") : from_v8<std::string>(isolate, value->TypeOf(isolate))))
{
}

GALLIUM_BINDER_NS_END
#endif //COCOA_GALLIUM_BINDER_CONVERT_H
