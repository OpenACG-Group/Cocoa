...
#define THIS_FILE_MODULE COCOA_MODULE_NAME(Cobalt.HWComposeContext)
...
co_sp<HWComposeContext> HWComposeContext::MakeVulkan(const Options& options)
{
...
co_sp<HWComposeSwapchain> HWComposeContext::CreateSwapchain(VkSurfaceFactory& factory,
