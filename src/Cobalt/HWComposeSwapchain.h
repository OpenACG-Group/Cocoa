#ifndef COCOA_COBALT_HWCOMPOSESWAPCHAIN_H
#define COCOA_COBALT_HWCOMPOSESWAPCHAIN_H
...
public:
    ...
    static co_sp<HWComposeSwapchain> Make(const co_sp<HWComposeContext>& context,
                                          VkSurfaceKHR surface, int32_t width, int32_t height);

    HWComposeSwapchain(co_sp<HWComposeContext> ctx, VkSurfaceKHR surface);
    ~HWComposeSwapchain();
...
private:
    ...
    co_sp<HWComposeContext>         context_;
...
#endif //COCOA_COBALT_HWCOMPOSESWAPCHAIN_H
