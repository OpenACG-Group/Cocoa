#ifndef COCOA_COBALT_HWCOMPOSECONTEXT_H
#define COCOA_COBALT_HWCOMPOSECONTEXT_H
...
public:
    ...
    {
    public:
        virtual VkSurfaceKHR Create(const co_sp<HWComposeContext>& context) = 0;
    };
    ...
    static co_sp<HWComposeContext> MakeVulkan(const Options& options);
    ...
    g_nodiscard co_sp<HWComposeSwapchain> CreateSwapchain(VkSurfaceFactory& factory,
...
#endif //COCOA_COBALT_HWCOMPOSECONTEXT_H
