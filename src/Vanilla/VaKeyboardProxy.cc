...
VaKeyboardProxy::VaKeyboardProxy(xkb_context *pCtx,
                                 xkb_keymap *pKeymap,
                                 xkb_state *pState)
    : fXkbContext(pCtx),
      fXkbKeymap(pKeymap),
...
VaKeyboardProxy::~VaKeyboardProxy()
{
    xkb_context_set_user_data(fXkbContext, nullptr);
}

Bitfield<KeyModifier> VaKeyboardProxy::activeMods()
{
...
Bitfield<KeyLed> VaKeyboardProxy::activeLeds()
{
