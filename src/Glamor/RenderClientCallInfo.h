...
#ifndef COCOA_GLAMOR_RENDERCLIENTCALLINFO_H
#define COCOA_GLAMOR_RENDERCLIENTCALLINFO_H
...
public:
    ...
    g_nodiscard g_inline Shared<RenderClientObject> GetThis() const {
        return this_;
    }
    ...
    g_private_api g_inline void SetThis(const Shared<RenderClientObject>& pThis) {
        this_ = pThis;
    }
...
#endif //COCOA_GLAMOR_RENDERCLIENTCALLINFO_H
