...
## 20 Feb 2022, Sat.
* ### New subproject `Comiket`
I launched a subproject named `Comiket` written in Python. Aiming to implement a very simple
scenario parser and representer based on `curses` library, I will work on it just for fun.

* ### Language bindings
Most filesystem APIs in `core` language binding are now completed except directory APIs.
The fundamental part of `cobalt` language binding are now completed.
